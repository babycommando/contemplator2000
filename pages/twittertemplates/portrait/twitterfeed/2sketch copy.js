...
function draw() {
  background(255);
  //default image
  image(aliendatacenter, 650, 13, 540, 675);
  //image(aliendatacenter, 650, 26, 600, 750);

  //input img
  if (img) {
    image(img, 650, 13, 540, 675);
    }
  ...
  //draw hen logo
  image(hen, 52, 0, 300, 170);

  // display text from Artwork Name input
  textSize(40);
  text(input2.value(), 100, 230);
  textStyle(BOLD);

  //display text from Artist Name input
  textSize(22);
  text(input3.value(), 100, 180);
  textStyle(BOLD);

  //DESCRIPTION Counter Input
  textSize(20);
  text(input6.value(), 100, 330);
  textStyle(BOLD);

  //OBJKT counter Input
  textSize(30);
  text(input4.value(), 100, 630);
  textStyle(BOLD);

  //EDITIONS Counter Input
  textSize(30);
  text(input5.value(), 100, 597);
  textStyle(BOLD);

  //LINK Input
  textSize(16);
  text(input7.value(), 100, 653);
  textStyle(BOLD);
